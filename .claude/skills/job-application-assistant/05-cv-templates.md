...
<!-- Populated from documents/cv/ on 2026-07-07 -->
**For enterprise / B2B SaaS Account Executive roles:**
> Enterprise B2B sales executive with eight years of full-cycle experience across SaaS, industrial, and regulated industries. Currently drives new-business development for an AI-native SaaS platform at Arcestra.ai, converting enterprise data center and healthcare accounts (CyrusOne, Texas Children's Hospital) from cold outreach to committed pilots. Track record includes a $3M-annual-minimum, 12-year exclusive distribution agreement and a six-figure Fortune 100 contract with Honeywell. Brings deal ownership from first contact through close, and comfort engaging FinOps, Engineering, and Operations leadership on technically complex products.
